...
parser.add_argument('--save_dir', default="output/resnet", type=str,
                    help='Where to save the adversarial examples, and other results')
parser.add_argument('--images_root', default="imagenet-compatible/images", type=str,
                    help='The clean images root directory')
parser.add_argument('--label_path', default="imagenet-compatible/labels.txt", type=str,
...
parser.add_argument('--attack_loss_weight', default=10, type=float, help='attack loss weight factor')
parser.add_argument('--self_attn_loss_weight', default=100, type=float, help='self attention loss weight factor')
parser.add_argument('--kl_prior_loss_weight', default=100, type=float, help='KL divergence prior loss weight factor for latent variables')

parser.add_argument('--deco_num_warping', default=5, type=int, help='number of warping transformation samples for deco')
parser.add_argument('--deco_rho', default=1, type=float, help='learning rate for updating noise map in deco')
parser.add_argument('--deco_mesh_width', default=3, type=int, help='mesh width for TPS in deco')
parser.add_argument('--deco_mesh_height', default=3, type=int, help='mesh height for TPS in deco')
parser.add_argument('--deco_noise_scale', default=2.0, type=float, help='random noise strength for deco')
...
def run_diffusion_attack(image, label, diffusion_model, diffusion_steps, guidance=3,
